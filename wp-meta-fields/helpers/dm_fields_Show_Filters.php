...
/**
 * Show On Filters
 * Use the 'dm_show_on' filter to further refine the conditions under which a metabox is displayed.
...
class dm_fields_Show_Filters {
	...
	public static function check_id( $display, $meta_box ) {
		...
		$object_id = dm_fields::get_object_id();
	...
	public static function check_page_template( $display, $meta_box ) {
		...
		if ( ! $object_id || dm_fields::get_object_type() !== 'post' )
			return false;
