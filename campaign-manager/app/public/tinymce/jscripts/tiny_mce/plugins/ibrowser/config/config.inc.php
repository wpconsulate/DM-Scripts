...
/*		array (
	...
	$cfg['ilibs'] = array (																// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions	
		array (																		
			'value'   	=> $_SERVER['DOCUMENT_ROOT'].'/wp-content/plugins/campaign-manager/app/public/tinymce/jscripts/tiny_mce/plugins/jbimages/images/images/',												
			'text'    	=> 'Site Pictures',
		),
		array (
			'value'   	=> $_SERVER['DOCUMENT_ROOT'].'/wp-content/plugins/campaign-manager/app/public/tinymce/jscripts/tiny_mce/plugins/jbimages/images/', 				
			'text'    	=> 'Gallery',
		),	
	);
	//-------------------------------------------------------------------------
