<?php
/**
 * Class that'll handle cross network Data
 */
class NetworkData
{
	 ...
	 */
	public function NetworkData($data) {
	...
	/**
	 * Returns whether this network publish data has been modified and needs to be saved.
	 */
	...
	public function is_empty() {
		...
		return( (count($this->data) == 1) && ( isset($this->data[ 'version' ]) ) );
